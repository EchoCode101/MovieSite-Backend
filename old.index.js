...
// import logStream from "./Utilities/morganLogs.js";
...
// app.use(helmet());
// app.use(morgan("combined", { stream: logStream })); // You can also use other formats, like 'tiny' or 'dev', depending on your needs
// // Encryption function
